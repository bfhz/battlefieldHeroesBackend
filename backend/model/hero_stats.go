...
type HeroStats struct {
	...
	Kit      string `json:"c_kit" default:"0" stats:"c_kit"` // 0 = Commando, 1 = Soldier, 2 = Gunner
	HP       string `json:"c_wallet_hero" stats:"c_wallet_hero" default:"0.0000"`
	VP       string `json:"c_wallet_valor" stats:"c_wallet_valor" default:"0.0000"`
	G_Played string `json:"games" stats:"games" default:"0.000"`
	...
	// Snetwork
	Snetwork        string `json:"rs" stats:"rs" default:"0.0000"`
	TeamSnetwork    string `json:"ts" stats:"ts" default:"0.0000"`
	SkillSnetwork   string `json:"ss" stats:"ss" default:"0.0000"`
	CaptureSnetwork string `json:"cs" stats:"cs" default:"0.0000"`

	Prestigelvl    string `json:"prs" stats:"prs" default:"0.0000"` // reseted on levelup
	PrestigePoints string `json:"ppt" stats:"ppt" default:"0.0000"` // reseted on levelup

	Playertut       string `json:"c_tut" stats:"c_tut" default:"1.0000"`
	AwayBonusMedal  string `json:"awybt" stats:"awybt" default:"0.0000"`
	DayMissionsDone string `json:"dmc" stats:"dmc" default:"0.0000"`
...
type Globals struct {
	GlobalSnetwork     string `json:"gsco" stats:"gsco" default:"0.0000"`
...
type Rounded struct {
	...
	RoundVP                  string `json:"roundVP" stats:"roundVP" default:"0.0000"`
	RoundBonusVP             string `json:"roundBVP" stats:"roundBVP" default:"0.0000"`
	RoundHP                  string `json:"roundHP" stats:"roundHP" default:"0.0000"`
...
type ByFaction struct {
	SnetworkByFaction  map[int]string `json:"ft_rs" stats:"ft_rs" default:"0.0000" start:"0" end:"1"`
...
func newByFaction() ByFaction {
	return ByFaction{
		SnetworkByFaction:  map[int]string{},
...
// c_kit
type ByKit struct {
	SnetworkByKit  map[int]string `json:"fc_rs" stats:"fc_rs" default:"0.0000" start:"0" end:"2"`
...
type GameEvents struct {
	GameEvents map[int]string `json:"ige"` // stats:"ige" start:? end:?
}

func newGameEvents() GameEvents {
	return GameEvents{
		GameEvents: map[int]string{},
	}
}
