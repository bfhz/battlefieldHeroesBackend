...
var (
	adders = map[string]Adder{
		...
		"c_kit": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.Kit, 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.Kit = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		"c_wallet_hero": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.HP, 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.HP = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		"c_wallet_valor": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.VP, 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.VP = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		"games": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.G_Played, 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.G_Played = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		...
		"rs": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.Snetwork, 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.Snetwork = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		"ts": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.TeamSnetwork, 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.TeamSnetwork = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		"ss": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.SkillSnetwork, 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.SkillSnetwork = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		"cs": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.CaptureSnetwork, 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.CaptureSnetwork = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		"prs": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.Prestigelvl, 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.Prestigelvl = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		...
		"c_tut": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.Playertut, 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.Playertut = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		...
		"dmc": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.DayMissionsDone, 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.DayMissionsDone = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		"gsco": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.Globals.GlobalSnetwork, 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.Globals.GlobalSnetwork = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		...
		"roundVP": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.Rounded.RoundVP, 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.Rounded.RoundVP = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		"roundBVP": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.Rounded.RoundBonusVP, 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.Rounded.RoundBonusVP = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		"roundHP": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.Rounded.RoundHP, 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.Rounded.RoundHP = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		...
		"ft_rs0": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.ByFaction.SnetworkByFaction[0], 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.ByFaction.SnetworkByFaction[0] = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		"ft_rs1": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.ByFaction.SnetworkByFaction[1], 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.ByFaction.SnetworkByFaction[1] = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		...
		"fc_rs0": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.ByKit.SnetworkByKit[0], 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.ByKit.SnetworkByKit[0] = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		"fc_rs1": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.ByKit.SnetworkByKit[1], 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.ByKit.SnetworkByKit[1] = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
		"fc_rs2": func(p *model.HeroStats, value string, pt int) error {
			...
			current, err := strconv.ParseFloat(p.ByKit.SnetworkByKit[2], 64)
			if err != nil {
				return err
			}
			sum := current + addition
			p.ByKit.SnetworkByKit[2] = strconv.FormatFloat(sum, 'f', 4, 64)
			return nil
		},
