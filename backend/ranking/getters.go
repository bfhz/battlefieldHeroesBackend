...
var (
	getters = map[string]Getter{
		...
		"dmc": func(p *model.HeroStats) (string, error) {
			if p.DayMissionsDone == "" {
				return "0.0000", nil
			}
			return p.DayMissionsDone, nil
		},
		"gsco": func(p *model.HeroStats) (string, error) {
			if p.Globals.GlobalSnetwork == "" {
				return "0.0000", nil
			}
			return p.Globals.GlobalSnetwork, nil
		},
		...
		"roundVP": func(p *model.HeroStats) (string, error) {
			if p.Rounded.RoundVP == "" {
				return "0.0000", nil
			}
			return p.Rounded.RoundVP, nil
		},
		"roundBVP": func(p *model.HeroStats) (string, error) {
			if p.Rounded.RoundBonusVP == "" {
				return "0.0000", nil
			}
			return p.Rounded.RoundBonusVP, nil
		},
		"roundHP": func(p *model.HeroStats) (string, error) {
			if p.Rounded.RoundHP == "" {
				return "0.0000", nil
			}
			return p.Rounded.RoundHP, nil
		},
		...
		"ft_rs0": func(p *model.HeroStats) (string, error) {
			if p.ByFaction.SnetworkByFaction[0] == "" {
				return "0.0000", nil
			}
			return p.ByFaction.SnetworkByFaction[0], nil
		},
		"ft_rs1": func(p *model.HeroStats) (string, error) {
			if p.ByFaction.SnetworkByFaction[1] == "" {
				return "0.0000", nil
			}
			return p.ByFaction.SnetworkByFaction[1], nil
		},
		...
		"fc_rs0": func(p *model.HeroStats) (string, error) {
			if p.ByKit.SnetworkByKit[0] == "" {
				return "0.0000", nil
			}
			return p.ByKit.SnetworkByKit[0], nil
		},
		"fc_rs1": func(p *model.HeroStats) (string, error) {
			if p.ByKit.SnetworkByKit[1] == "" {
				return "0.0000", nil
			}
			return p.ByKit.SnetworkByKit[1], nil
		},
		"fc_rs2": func(p *model.HeroStats) (string, error) {
			if p.ByKit.SnetworkByKit[2] == "" {
				return "0.0000", nil
			}
			return p.ByKit.SnetworkByKit[2], nil
		},
